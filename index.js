...
function textosCharros(){
    ...
    let textoAleatorio = textosCharros[indiceAleatorio];
        ...
        (i.Keyboard.prototype = {
            ...
            processKeyDown: function (t) {
                this.game.input.disabled ||
                    ...
                    this._keys[t.keyCode] && this._keys[t.keyCode].isDown
                        ? (this._keys[t.keyCode].duration = this.game.time.now - this._keys[t.keyCode].timeDown)
                        : this._keys[t.keyCode]
                        ? ((this._keys[t.keyCode].isDown = !0), (this._keys[t.keyCode].timeDown = this.game.time.now), (this._keys[t.keyCode].duration = 0))
                        : (this._keys[t.keyCode] = { isDown: !0, timeDown: this.game.time.now, timeUp: 0, duration: 0 }),
    ...
    (main = function () {
        ...
        (h = function (t, e) {
            ...
            (t = function (t, e) {
                ...
                console.log(SPEED);
                invs.remove(e), (score += 1), scoreText.setText(localStorage.player||"p1 "+"\n"+score + " " + "\n velocidad:"+ SPEED), scoreSnd.play();
            }),
            (a = function () {
                var t;
                SPEED = 190;
            ...
            (e = function () {
                ...
                console.log("%chttps://github.com/hyspace/flappy", "color: black; font-size: x-large"),
                    ...
                    (scoreText = s.add.text(s.world.width / 2, s.world.height / 4, "", { font: '10px "Press Start 2P"', fill: "#fff", stroke: "#430", strokeThickness: 4, align: "center" })),
                    ...
                    (gameOverText = s.add.text(s.world.width / 2, s.world.height / 2, "", { font: '0px "Press Start 2P"', fill: "#fff", stroke: "#430", strokeThickness: 4, align: "center" })),
            ...
            (c = function () {
                ...
                (bird.body.allowGravity = !0), (bird.body.gravity.y = GRAVITY), (tubesTimer = s.time.events.loop(1 / SPAWN_RATE, l)), scoreText.setText(localStorage.player||"p1 "+"\n"+score + " " + "\n velocidad:"+ SPEED), (instText.renderable = !1), (gameStarted = !0);
            }),
            (d = function () {
                var e;
                gameStarted
